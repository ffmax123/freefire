        ...
        setButtonImage("https://cdn.jsdelivr.net/gh/tiptipios/ios@main/tiptip.jpg");

        var drawScreen, lockerBall;

        window.onload = function() {
                    // Lấy giá trị lưu trữ từ localStorage khi trang được tải lại
        ...
        document.getElementById('decreaseButton').addEventListener('click', function() {
            ...
            if (newValue >= parseFloat(sizeInput.min)) {
                ...
                localStorage.setItem('sizeInputValue', newValue.toFixed(2)); // Lưu giá trị vào localStorage
            }
        });
        ...
        document.getElementById('togglePointsCheckbox').addEventListener('change', function() {
            if (this.checked) {
                // Checkbox được bật, kích hoạt sự kiện 'click' cho startButton
                document.getElementById('startButton').click();
            } else {
                // Checkbox bị tắt, gọi hàm endDraw()
                endDraw();
            }
        });
            ...
            var savedSize = localStorage.getItem('sizeInputValue');
    if (savedSize) {
        document.getElementById('size').value = savedSize;
        document.getElementById('sizeValue').innerText = savedSize;
    }
                ...
                if (addr) {
                    ...
                    drawScreen = setInterval(function () {
                        ...
                        if (check > 1) {
                            ...
                            drawCircle(ctx, whiteLineValScreen.x_end, whiteLineValScreen.y_end, 2, "white");
                            ...
                            drawCircle(ctx, ballValScreen.x_end, ballValScreen.y_end, 2, "white");
